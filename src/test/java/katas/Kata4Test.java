...
public class Kata4Test {
    ...
    private final List<Map> moviesWithIDsAndBoxArtsForAssertion = ImmutableList.of(
            ImmutableMap.of(Constants.KEY_MOVIE_ID, 70111470, Constants.KEY_MOVIE_TITLE, "Die Hard",
                    Constants.KEY_BOX_ART, new BoxArt(150, 200, "http://cdn-0.nflximg.com/images/2891/DieHard150.jpg")),
            ImmutableMap.of(Constants.KEY_MOVIE_ID, 654356453, Constants.KEY_MOVIE_TITLE, "Bad Boys",
                    Constants.KEY_BOX_ART, new BoxArt(150, 200, "http://cdn-0.nflximg.com/images/2891/BadBoys150.jpg")),
            ImmutableMap.of(Constants.KEY_MOVIE_ID, 65432445, Constants.KEY_MOVIE_TITLE, "The Chamber",
                    Constants.KEY_BOX_ART, new BoxArt(150, 200, "http://cdn-0.nflximg.com/images/2891/TheChamber150.jpg")),
            ImmutableMap.of(Constants.KEY_MOVIE_ID, 675465, Constants.KEY_MOVIE_TITLE, "Fracture",
                    Constants.KEY_BOX_ART, new BoxArt(150, 200, "http://cdn-0.nflximg.com/images/2891/Fracture150.jpg"))
    );

    @Test
    public void testTheSizeOfTheReturnedMovieListShouldEqualToFour() {
        assertEquals(4, Kata4.execute().size());
    }
